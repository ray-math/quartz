...
2. $2009^{1002}$를 $100$으로 나눈 나머지를 구하여라. [^5]

3. $n^{1998} - 4$가 $17$의 배수가 되는 $n$의 최소값을 구하여라. [^4]
...
[^4]: $n$은 $17$의 배수가 아니므로, $\gcd(n, 17) = 1$이다. 오일러 정리에 의해 $\varphi(17) = 16$이므로 $n^{16} \equiv 1 \pmod{17}$이다. $1998 \equiv 14 \pmod{16} \Rightarrow n^{14} \equiv 4 \pmod{17}$ 즉, 이 문제는 결국 $n^{14} \equiv 4 \pmod{17}$을 만족하는 최소 자연수 $n$을 찾는 문제이다. $n^{16} \equiv 4n^2 \equiv 1 \pmod{17}$이므로, $n^2 \equiv -4 \pmod{17}$이다. 따라서 구하는 최솟값 $n=8$이다.
[^5]: $\gcd (2009, 100) = 1$이므로 오일러 정리에 의해 $2009^{40} \equiv 1 \pmod{100}$이다. $2009^{1002} = (2009^{40})^{25} \cdot 2009^2 \equiv 1^{25} \cdot 2009^2 \equiv 9^2 \pmod{100}$이다. 따라서 $2009^1002$를 $100$으로 나눈 나머지는 $81$이다.