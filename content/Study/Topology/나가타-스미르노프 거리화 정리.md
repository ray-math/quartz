...
### 
First countable(제1가산공간)이고 Hausdorff(하우스도르프)인 위상공간 $X$에서 임의의 한 점 집합 $\{x\}$이 $G_\delta$ 집합이 되는 이유는 다음과 같습니다. 

실수 전체 집합 $\mathbb{R}$에서 열린구간 $(-1/n, 1/n)$의 무한 교집합을 생각해봅니다. 즉,
